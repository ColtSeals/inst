			...
			switch(id)
			{
				case R.id.paygen:
					if (SkStatus.isTunnelActive()) {
						Toast.makeText(SocksHttpMainActivity.this, "O serviço VPN está em execução, pare primeiro!",Toast.LENGTH_SHORT).show();
						...
						if (customSetUP.isChecked()) {
							...
							Toast.makeText(SocksHttpMainActivity.this, "Bloqueado pelo desenvolvedor",Toast.LENGTH_SHORT).show();
                ...
                case R.id.fb_group:
                    String url2 = "https://www.facebook.com/groups/";
	...
	private void loadServerData() {
		try {
			...
			if (info.equals("sslp"))
			{
				...
				prefs.edit().putString(Settings.CUSTOM_PAYLOAD_KEY, "GET / HTTP/1.1[crlf]Host: "+ssh_server+"[crlf]Upgrade: websocket[crlf][crlf]").apply();
