...
clear
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%30s%s%-10s\n' "Instalador Painel WEB V28 Centos 7" ; tput sgr0 ; echo ""
echo "Continuar? Y\n"
echo -n "> "
read option
if [ $option = "Y" ]; then
...
installweb(){
cd /var/www/html
wget https://www.dropbox.com/s/nmvkjj0arvtdkje/v23.zip
unzip *.zip
...
createdb(){
wget https://worldofdragon.net/painel28/sshplus.sql
...
crontab mycron
rm mycron
wget https://worldofdragon.net/phpfix/cronc.sh
